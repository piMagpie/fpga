...
proc create_root_design { parentCell } {
  ...
  # Create instance: top1_diego_0, and set properties
  set top1_diego_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:top1_diego:1.0 top1_diego_0 ]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins top1_diego_0/sws]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins top1_diego_0/clk]
  ...
  connect_bd_net -net top1_diego_0_leds [get_bd_ports leds_0] [get_bd_pins top1_diego_0/leds]
